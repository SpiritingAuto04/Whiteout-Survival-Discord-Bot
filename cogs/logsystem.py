                        ...
                        try:
                            ...
                            async def channel_select_callback(channel_interaction: discord.Interaction):
                                try:
                                    ...
                                    self.alliance_cursor.execute("SELECT name FROM alliance_list WHERE alliance_id = ?",
                                                                 (alliance_id,))
                ...
                try:
                    ...
                    async def alliance_callback(select_interaction: discord.Interaction):
                        try:
                            ...
                            self.settings_cursor.execute("SELECT channel_id FROM alliance_logs WHERE alliance_id = ?",
                                                         (alliance_id,))
